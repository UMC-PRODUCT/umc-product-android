...
interface NoticeRepository {
    ...
    suspend fun submitVoteResponse(noticeId: Long, request: VoteResponseRequest): ApiState<Unit>
    suspend fun updateVoteResponse(noticeId: Long, request: VoteResponseRequest): ApiState<Unit>
}
        ...
        when (event) {
            ...
            is AdminActStudyScheduleAddEvent.UpdateStartDate -> {
                ...
                updateState {
                    copy(
                        startDate = newCal,
                        startDateText = AdminActStudyScheduleAddState.Companion.dateSdf.format(newCal.time)
                    )
                }
            }
            ...
            is AdminActStudyScheduleAddEvent.UpdateStartTime -> {
                ...
                updateState {
                    copy(
                        startTime = newCal,
                        startTimeText = AdminActStudyScheduleAddState.Companion.timeSdf.format(newCal.time)
                    )
                }
            }
            ...
            is AdminActStudyScheduleAddEvent.UpdateEndDate -> {
                ...
                updateState {
                    copy(
                        endDate = newCal,
                        endDateText = AdminActStudyScheduleAddState.Companion.dateSdf.format(newCal.time)
                    )
                }
            }
            ...
            is AdminActStudyScheduleAddEvent.UpdateEndTime -> {
                ...
                updateState {
                    copy(
                        endTime = newCal,
                        endTimeText = AdminActStudyScheduleAddState.Companion.timeSdf.format(newCal.time)
                    )
                }
            }

...
class UserCheckViewModel @Inject constructor() :
    ...
    private fun loadInitialData() {
        val availableList = listOf(
            AvailableSession(1, "스터디", "14:00", "18:00", AttendanceStatus.BEFORE),
            AvailableSession(2, "정기 세션 3주차", "14:00", "18:00", AttendanceStatus.BEFORE)
        ).map { CheckAvailableUIModel(it) }

        val rawHistoryList = listOf(
            AttendanceHistory(1, "3주차", "정기 세션", "14:00", "18:00", AttendanceStatus.SUCCESS),
            AttendanceHistory(2, "2주차", "정기 세션", "14:00", "18:00", AttendanceStatus.LATE),
            AttendanceHistory(3, "1주차", "정기 세션", "14:00", "18:00", AttendanceStatus.ABSENT)
        )

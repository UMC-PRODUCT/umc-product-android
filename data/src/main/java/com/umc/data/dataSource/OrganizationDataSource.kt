...
interface OrganizationDataSource {
    ...
    suspend fun getMyStudyGroup(
        cursor: Long?,
        size: Int,
    ): ApiState<StudyGroupListResponse>
    ...
    suspend fun getChapterWithSchool(
        gisuId: Int,
    ): ApiState<ChapterBySchoolListResponse>

    suspend fun getGisuInfo(
        gisuId: Long,
    ): ApiState<GisuInfoResponse>


    // PATCH
    suspend fun editGroup(
        groupId: Long,
        request: EditStudyGroupRequest,
    ): ApiState<Unit>

    suspend fun editSchool(
        schoolId: Int,
        request: EditSchoolRequest,
    ): ApiState<Unit>

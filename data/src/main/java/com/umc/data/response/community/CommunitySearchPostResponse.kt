...
import com.umc.data.response.community.PostSearchSummaryResponse.Companion.toContentItemDomain
import com.umc.domain.model.community.PostPageModel

data class CommunitySearchPostResponse (
    @SerializedName("content") val content: List<PostSearchSummaryResponse>, // 게시글 데이터 리스트
    ...
    companion object {
         ...
         */
        fun CommunitySearchPostResponse.toPostPageModelDomain(): PostPageModel = PostPageModel(
